      ...
      <section className="container px-4 mx-auto">
        <div className="flex items-center mt-6 text-center border rounded-lg h-96 dark:border-gray-700">
          <div className="flex flex-col w-full max-w-sm px-4 mx-auto">
            ...
            Chưa có dữ liệu danh sách sinh viên, vui lòng Tải xuống mẫu Template và Import lên đây
            </p>
            <div className="flex items-center mt-4 sm:mx-auto gap-x-3">
              <button className="w-1/2 px-5 py-2 text-sm text-gray-700 transition-colors duration-200 bg-white border rounded-lg sm:w-auto  ">
                Clear Search
              </button>
