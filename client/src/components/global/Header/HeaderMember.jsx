...
const Header = () => {
  ...
  return (
    <div className="h-20 w-full shadow-xl shadow-gray-400 border-b-2 border-gray-200 flex items-center justify-between px-4">
      <div className=""></div>
      <div className="flex items-center gap-4">
        <div className="flex items-center gap-3">
          <h1>Xin chào, {currentUser[0].memberName}</h1>
          <img src={user} alt="" />
        </div>
