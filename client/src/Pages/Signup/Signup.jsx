...
const Signup = () => {
  ...
  const onFinish = async (values) => {
    ...
    if (values.password === values.passwordRe) {
      try {
        const res = await request.post("action/signup", dataSubmit);
        console.log(res, "res");
        if (res.status == 201) {
        ...
        message.error("Đã có lỗi xảy ra, hãy kiểm tra lại");
      }
    } else {
      message.error("Mật khẩu nhập lại không khớp, hãy kiểm tra lại");
    }
  };
        ...
        <div class="max-w-md w-full p-6">
          ...
          >
            ...
            <div className="">
              ...
              >
                <DatePicker className="mt-1 p-2 w-full border rounded-md focus:border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300" />
              </Form.Item>
            </div>
            ...
            <Form.Item>
              <button
                className="w-full bg-red-600 text-white p-2 rounded-md hover:bg-red-800 focus:outline-none focus:bg-red-500  focus:ring-2 focus:ring-offset-2 focus:ring-red-400 transition-colors duration-300"
                type="primary"
                htmlType="submit"
              >
                Đăng ký
          ...
          <div class="mt-4 text-sm text-gray-600 text-center">
            <p>
              Đã có tài khoản ?
              <Link to="/signup" class="text-red-600 hover:underline">
                Đăng nhập
              </Link>
            </p>
          </div>
